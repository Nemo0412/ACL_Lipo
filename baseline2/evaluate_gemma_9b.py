...
def main():
    ...
    # 模型路径 - 使用本地下载的 Google TXGemma-9B-Chat
    model_name = "/tmp/txgemma-9b-chat"
    ...
    # 测试数据路径
    eff_test_file = '/mnt/3fs/dots-pretrain/leshu/workspace/Haiyu-Qwen30B/data/efficiency_test_data_rdkit.jsonl'
    tox_test_file = '/mnt/3fs/dots-pretrain/leshu/workspace/Haiyu-Qwen30B/data/toxic_data/toxicity_test_data_rdkit.jsonl'
    ...
    output_file = '/mnt/3fs/dots-pretrain/leshu/workspace/baseline2/gemma_9b_evaluation_results.json'
