...
Usage:
  python upload_to_hub.py \
      ...
      --hf_repo      YOUR_HF_USERNAME/txgemma-9b-lipo-finetuned \
...
def parse_args():
    ...
    p.add_argument("--base_model",   default="google/txgemma-9b-chat")
    p.add_argument("--adapter_path", required=True,
                   help="Path to saved LoRA adapter (final_adapter/)")
    p.add_argument("--hf_repo",      required=True,
                   help="HuggingFace repo ID, e.g. YOUR_USER/txgemma-9b-lipo")
